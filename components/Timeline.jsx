    ...
    <section id="timeline" className="py-16 md:py-24 relative overflow-hidden bg-gradient-to-br from-[#0a0e27] via-[#1a1f3a] to-[#0a0e27]">
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="mt-10 relative">
          {/* Vertical line */}
          <div className="absolute left-4 md:left-1/2 md:-translate-x-1/2 top-0 bottom-0 w-[2px] bg-gradient-to-b from-blue-400 via-[#0047AB] to-[#00B4FF]" />
          ...
          <div className="space-y-10">
            {items.map((it, i) => (
              <motion.div
                ...
                className={`relative md:w-1/2 ${i % 2 ? 'md:ml-auto md:pl-10' : 'md:pr-10'} pl-12 group`}
              >
                {/* node */}
                <div className="absolute left-4 md:left-auto md:right-[-7px] top-2">
                  <motion.span 
