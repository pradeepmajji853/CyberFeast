...
const items = [
  {
    ...
    desc: 'Intro to cyber security, career paths, alumni interaction & Q&A. Venue: Assembly Hall.',
    icon: FaRocket,
  },
  {
    day: 'Day 1',
    ...
    desc: 'Disk and email analysis using TSK and web tools. Venue: TPO Labs 2 & 4.',
    icon: FaTools,
  },
  {
    day: 'Day 2',
    ...
    time: '9:30 AM – 12:30 PM',
    desc: 'Practical challenges: file recovery, metadata, email headers, and incident timeline. Venue: TPO Labs 2 & 4.',
