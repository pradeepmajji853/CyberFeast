...
import { FaBriefcase, FaMicroscope, FaTrophy, FaGift, FaCertificate, FaGoogle, FaMoneyBillWave, FaStar, FaUsers, FaRocket } from 'react-icons/fa'
...
const prizes = [
  { icon: FaMoneyBillWave, title: 'Cash Prizes', desc: 'Win exciting cash rewards', color: 'from-green-500 to-emerald-500' },
  { icon: FaGoogle, title: 'Google Credits', desc: 'Cloud platform credits', color: 'from-blue-500 to-cyan-500' },
  { icon: SiGooglegemini, title: 'Gemini Certificates', desc: 'Official AI certifications', color: 'from-purple-500 to-pink-500' },
  { icon: FaGift, title: 'Goodies', desc: 'Exclusive swag & merchandise', color: 'from-orange-500 to-red-500' },
]
...
const features = [
  ...
  { icon: FaStar, title: '100% Free', desc: 'Everything free for all attendees!' },
]
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          {features.map((feature, idx) => (
            <motion.div
              ...
              className="group relative bg-gradient-to-br from-[#1a1f3a]/80 to-[#0e1833]/80 backdrop-blur-sm border border-cyan-500/20 rounded-2xl p-6 hover:border-cyan-400/40 transition-all duration-300"
            >
        ...
        >
          <div className="rounded-3xl bg-gradient-to-br from-[#1a1f3a] via-[#0e1833] to-[#1a1f3a] border border-cyan-500/30 overflow-hidden">
            {/* Glow effect */}
            <div className="absolute -inset-1 bg-gradient-to-r from-blue-500/20 via-cyan-500/20 to-purple-500/20 blur-xl opacity-50" />
            ...
            <div className="relative p-8 md:p-12">
              <div className="grid md:grid-cols-2 gap-10 items-center">
                <div>
                  ...
                  >
                    ...
                    <motion.a
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/50 transition-all duration-300"
                    >
                      Reserve Your Seat
                ...
                >
                  ...
                  >
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-purple-600/30 to-pink-600/30 border border-purple-500/30 text-purple-300 text-sm">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          >
            ...
            <div className="relative">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold"
              >
                Join Workshop
              </motion.a>
            </div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            whileHover={{ y: -5 }}
            className="group relative rounded-3xl bg-gradient-to-br from-[#1a1f3a]/90 to-[#0e1833]/90 border border-purple-500/30 p-8 hover:border-purple-400/50 transition-all duration-300 overflow-hidden"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            <div className="relative">
              <div className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-purple-600/30 to-pink-600/30 text-purple-400 mb-6">
              ...
              <ul className="space-y-2 mb-6 text-gray-300">
                {['Solo & team competitions', 'Real-world scenarios', 'Multiple difficulty levels', 'Live leaderboard'].map((item, idx) => (
                  <li key={item} className="flex items-start gap-2">
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.98 }}
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold"
              >
                Take Challenge
              </motion.a>
            </div>
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="rounded-3xl bg-gradient-to-br from-yellow-600/20 via-orange-600/20 to-red-600/20 border border-yellow-500/30 p-8 md:p-12 overflow-hidden">
            <div className="absolute -inset-1 bg-gradient-to-r from-yellow-500/20 via-orange-500/20 to-red-500/20 blur-2xl opacity-40" />
            ...
            <div className="relative text-center mb-10">
              ...
              <p className="text-xl text-gray-200 max-w-2xl mx-auto">
                Win amazing prizes, certifications, and rewards - <strong className="text-yellow-400">All Completely FREE!</strong>
              </p>
            </div>
            ...
            >
              <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-green-600/30 to-emerald-600/30 border border-green-500/40 text-green-300 text-lg font-semibold">
                <FaStar className="text-yellow-400" />
                <span>Plus: Certificates & Goodies for ALL Participants!</span>
                <FaStar className="text-yellow-400" />
              </div>
            </motion.div>
          </div>
        ...
        >
          <motion.a
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.98 }}
            className="inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-gradient-to-r from-blue-600 via-cyan-600 to-purple-600 text-white text-lg font-bold shadow-2xl shadow-blue-500/40 hover:shadow-3xl hover:shadow-blue-500/60 transition-all duration-300"
          >
          ...
          <p className="mt-4 text-gray-400">
            Limited seats available. Don't miss out on this amazing opportunity!
          </p>
        </motion.div>
      </div>
    </section>
